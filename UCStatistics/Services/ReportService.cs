...
namespace UCStatistics.Services
{
    public class ReportService
    {
        ...
        public Task<IEnumerable<LiveBranchDto>> GetLiveBranchSummaryAsync(FilterCriteria criteria)
        {
            return _repository.GetLiveBranchSummaryAsync(criteria);
        }
        ...
        public async Task<byte[]> ExportIndividualTicketsToExcelAsync(FilterCriteria criteria)
        {
            ...
            var excelService = new ExcelExportService();
            return excelService.ExportIndividualTicketsToExcel(data, "Branch Summary");
        }
    }
}
